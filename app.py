...
# Credentials loaded from environment variables for production
VALID_USERNAME = os.environ.get('VALID_USERNAME', 'test')
VALID_PASSWORD = os.environ.get('VALID_PASSWORD', 'test123')
